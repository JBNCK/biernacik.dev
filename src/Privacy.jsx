...
function Privacy() {
    ...
    const pageTitle = isGerman() ? "Datenschutz" : "Privacy";
    const privacyPolicy = navigator.language === "de-DE" ? (
        <>
            ...
            <>
                ...
                <div className="main-section">
                    <h3>General Information on Data Storage and Deletion</h3>
                ...
                <div className="main-section">
                    <h3>Provision of the Online Offering and Web Hosting</h3>
